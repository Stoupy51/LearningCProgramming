...
int main() {
	...
	// Indice pour l'affichage de la chaîne de caractères : '\' est un caractère d'échappement,
	// il permet d'insérer des caractères spéciaux dans une chaîne de caractères, ex: \" affichera "
	printf("");
	printf("");
	printf("");
	printf("");
